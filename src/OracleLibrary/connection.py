...
class Connection(object):
    ...
    def connect_to_database_by_tns(self, user_name, password, network_alias, encoding="American_America.AL32UTF8"):
        environ["NLS_LANG"] = encoding
        self.connection = cx_Oracle.connect(user_name, password, network_alias)

    def connect_to_database_by_connection_string(self, connection_string, encoding="American_America.AL32UTF8"):
        environ["NLS_LANG"] = encoding
